%fold-1
model1=svmtrain(Yeast_f1_train_label,Yeast_f1_train_feature,'-c 0.7 -g 1  -b 1');
...
%fold-2
model2=svmtrain(Yeast_f2_train_label,Yeast_f2_train_feature,'-c 0.7 -g 1  -b 1');
...
%fold-3
model3=svmtrain(Yeast_f3_train_label,Yeast_f3_train_feature,'-c 0.7 -g 1  -b 1');
...
%fold-4
model4=svmtrain(Yeast_f4_train_label,Yeast_f4_train_feature,'-c 0.7 -g 1  -b 1');
...
%fold-5
model5=svmtrain(Yeast_f5_train_label,Yeast_f5_train_feature,'-c 0.7 -g 1  -b 1');
